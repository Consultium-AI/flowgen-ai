...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    function update(time: number) {
      ...
      const mouseDst = program.uniforms.uMouse.value as Float32Array;
      if (enableMouseInteraction) {
        currentMouse[0] += 0.05 * (targetMouse[0] - currentMouse[0]);
        currentMouse[1] += 0.05 * (targetMouse[1] - currentMouse[1]);
        mouseDst[0] = currentMouse[0];
        mouseDst[1] = currentMouse[1];
      } else {
        mouseDst[0] = 0.5;
        mouseDst[1] = 0.5;
      }
  ...
  return (
    <div ref={containerRef} className={clsx("line-waves-container", className)} />
  );
}
