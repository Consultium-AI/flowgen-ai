...
const NOTES: Record<string, string> = {
  pilot:
    "Je komt vanuit het Pilot-pakket: we bereiden dit gesprek daar specifiek op voor.",
  growth:
    "Je komt vanuit het Growth-pakket: we bereiden dit gesprek daar specifiek op voor.",
  maatwerk:
